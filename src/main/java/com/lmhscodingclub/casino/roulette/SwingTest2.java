...
public class SwingTest {
    ...
    public static void startUpGame() {
        ...
        for (int y = 0; y < bottom1.length; y++) {
            ...
            buttons2[y].addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent gg) {
                    String chh = gg.getActionCommand();
                    System.out.println("You have clicked button " + chh);
                }
            });
        ...
        for (int a = 0; a < 13; a++) {
            ...
            String choice2 = String.valueOf(a);
            buttons3[a].setActionCommand(choice2);
            buttons3[a].addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent gf) {
                    String hc = gf.getActionCommand();
                    System.out.println("You have clicked button " + hc);
                }
            });
            p8.add(buttons3[a]);
        }
        ...
        for (int b = 0; b < 13; b++) {
            ...
            String choice3 = String.valueOf(b);
            buttons4[b].setActionCommand(choice3);
            buttons4[b].addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent fh) {
                    String ag = fh.getActionCommand();
                    System.out.println("You have clicked button " + ag);
                }
            });
            p9.add(buttons3[b]);
        }
